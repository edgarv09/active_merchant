...
class RemoteMundipaggTest < Test::Unit::TestCase
  ...
  def test_failed_purchase_with(card, msg = nil)
    error_message = msg || 'Simulator|Transação de simulada negada por falta de crédito,"\
      " utilizado para realizar simulação de autorização parcial.'
